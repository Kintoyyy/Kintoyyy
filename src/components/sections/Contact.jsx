  ...
  return (
    <section id="contact" className="mt-16 pt-12 px-6 lg:px-24">
      ...
      <h4 className="text-5xl font-bold text-zinc-900 dark:text-zinc-100">
        Let&apos;s Get in Touch:{" "}
        <span className="text-blue-800 dark:text-blue-500">Ways to Connect with Me</span>
      </h4>
      ...
      <div className="mt-12">
        ...
        <a
          ...
          <FaFacebook className="self-center text-lg text-blue-800 dark:text-blue-500" />
        ...
        <a
          ...
          <FaSquareXTwitter className="self-center text-lg text-blue-800 dark:text-blue-500" />
        ...
        <a
          ...
          className="flex gap-4 text-zinc-600 dark:text-zinc-300 hover:dark:text-zinc-300 hover:text-zinc-700 transition-all duration-300 mt-4">
          <FaInstagram className="self-center text-lg text-blue-800 dark:text-blue-500" />
